...
// Define expression and result veriable
let expression = ''
let result = ''
...
function buttonClick(event) {
    ...
    switch (action) {
        ...
        case 'backspace':
            backspace()
        break
        // Add the result to expression as a starting point is expression is empty
        case 'addition':
        case 'subtraction':
        case 'multiplication':
        case 'division':
...
function evaluateExpression() {
    ...
    // Checks if evalResult isNaN or infinite. It if is, return a space characheter ' '
...
function percentage() {
    ...
    if (expression !== '') {
        ...
        // If expression is empty but the result exisists, divide by 100
